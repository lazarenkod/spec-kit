...
| ID | Classification | Given | When | Then | Requires Test | Confidence |
|----|----------------|-------|------|------|---------------|------------|
| AS-1A | HAPPY_PATH | [initial state] | [action] | [expected outcome] | YES | 0.95 |
| AS-1B | ERROR_PATH | [initial state] | [action] | [expected outcome] | YES | 0.90 |

<!--
  NEW: Confidence column (0.0-1.0) indicates AI confidence in scenario necessity:
  ...
  Scenarios with confidence < 0.70 should be reviewed for clarity or necessity.
-->
